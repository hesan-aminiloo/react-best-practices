...
## :book: Table of Contents
  ...
  1. [File and Folder Structure](#folder-and-files)
    ...
    1. [Type Based](#folder-type-based)
  1. [Necessary Libraries](#required-libs)
    1. [Axios](#libs-axios)
    1. [ESLint](#libs-eslint)
    1. [Moment](#libs-moment)
    1. [React Router Dom](#libs-router)
    1. [Redux](#libs-redux)
    1. [Third-Party Libs](#libs-redux)
  ...
  1. [Components](#components)
    ...
    1. [Higher-Order Components](#class-hoc)
  1. [Styling](#component-stylings)
    1. [SCSS](#styling-scss)
    1. [styled-components](#styling-styled-component)
    1. [Inline Styling](#styling-inline)
  1. [Images](#assets)
